...
uint32_t Piano_LUT[NS] = {1954, 2197, 1809, 2069, 1978, 2018, 1946, 2155,
...
uint32_t Guitar_LUT[NS] = {1276, 1960, 2368, 1662, 2006, 916, 628, 2877,
...
uint32_t Drum_LUT[NS] = {2036, 3354, 1870, 2112, 2057, 3358, 1902, 1932,
...
// Array of LUT pointers for easy switching
uint32_t* LUTs[] = {Sin_LUT, Saw_LUT, Triangle_LUT, Piano_LUT, Guitar_LUT, Drum_LUT};
